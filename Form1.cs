...
namespace LoginRegistrationForm
{
    public partial class Form1 : Form
    {
        ...
        {
            //Instrukcja przenosząca do formularza rejestracji
        ...
        private void login_btn_Click(object sender, EventArgs e)
        {
            ...
            if(login_username.Text == "" || login_password.Text == "")
            {
                ...
                MessageBox.Show("Proszę wypełnić pola.", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                ...
                try
                {
                    ...
                    String selectData = "SELECT * FROM users WHERE username = @username AND password = @pass"; //Ustanowienie zapytania SQL, jako zmiennej
                    ...
                    { 
                        ...
                        if (table.Rows.Count >= 1) //Warunek sprawdzający czy liczba zgadzających się rekordów jest większa od zera
                        {
                            ...
                            MessageBox.Show("Zalogowano", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);

                            //Przejście do ekranu powitalnego użytkownika
                        ...
                        else //Jeśli zapytanie nie zwróci żadnych rekordów, wtedy dane logowania nie są poprawne
                        {
                            ...
                            MessageBox.Show("Nie właściwy login lub hasło", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
                    }
                }
        ...
        //Przycisk przenoszący do formularza logowania administratora
        private void admin_btn_Click(object sender, EventArgs e)
        {
            //Instrukcja przejścia do ekranu logowania administratora
